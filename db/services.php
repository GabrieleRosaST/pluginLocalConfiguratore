...
$functions = [
    ...
    'local_configuratore_update_chatbot_basic' => [
        'classname'   => 'local_configuratore_external',
        'methodname'  => 'update_chatbot_basic',
        'classpath'   => 'local/configuratore/externallib.php',
        'description' => 'Aggiorna solo i dati base della configurazione del chatbot.',
        'type'        => 'write',
        'capabilities' => 'local/configuratore:manage',
        'ajax'        => true,
    ],

    'local_configuratore_check_course_name_exists' => [
        'classname'   => 'local_configuratore_external',
        'methodname'  => 'check_course_name_exists',
        'classpath'   => 'local/configuratore/externallib.php',
        'description' => 'Verifica se esiste già un corso con lo stesso nome',
        'type'        => 'read',
        'capabilities' => 'local/configuratore:manage',
        'ajax'        => true,
    ],
